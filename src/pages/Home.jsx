  ...
  return (
    <div className='text-[#4E5562]'>
      ...
      <div className="flex justify-center items-center mt-20">
        <h3 className="text-xl">ELSO Solar Business Directory</h3>
      </div>
      ...
      <div className="flex gap-4 mb-16 flex justify-center items-center">
        <div>• Verified Listings</div>
        <div>• Global Reach</div>
        <div>• Ease of Use</div>
      </div>

      <div className="flex items-center gap-4 border border-gray-300 shadow-lg py-3 px-4 rounded-full text-[#6B7280] w-5/12 mx-auto mt-10 mb-32">
      ...
      <div>
      <div className="grid grid-cols-8 mt-12 text-center text-[#6B7280]">
        <div>
          <p>Installers</p>
